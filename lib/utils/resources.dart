...
const FATHERS_SAY_DETAILS = [
  ...
  },
  {
    ...
    QUOTE_KEY: 'ان كتاب الله نهر فيه يمكن ان يعوم الفيل كما انه يمكن ان يعبره الحمل الصغير',
    PIC_KEY: 'assets/images/cross.jpg',
  },
  {
    NAME_KEY: 'القديس يوحنا ذهبي الفم',
    QUOTE_KEY: 'من يعرف الكتاب المقدس حق المعرفة لن يتعثر في شيء بل سيحتمل كل شيء بصبر و نبل',
    PIC_KEY: 'assets/images/pic3.jpg',
  },
  {
    NAME_KEY: 'القديس اوغسطينوس',
    QUOTE_KEY: 'الكتاب المقدس هو سيف الانتصار على فيض الخلاعة التي اوشكت ان تقضي على الاداب المسيحية',
